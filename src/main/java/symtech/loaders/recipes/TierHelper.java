...
/**
 * Copied from <a href="https://github.com/Zorbatron/ZBGT">ZBGT</a> RecipeAssists.
 *
 * Might end up removing this since I found CraftingComponent from CEu.
 */
public class TierHelper {
    ...
    public static ItemStack getMachineHullByTier(int tier) {
