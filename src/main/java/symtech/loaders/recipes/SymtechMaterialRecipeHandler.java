...
import symtech.api.unification.material.properties.SymtechPropertyKey;
import symtech.api.unification.material.properties.FiberProperty;
...
public class SymtechMaterialRecipeHandler {
    // For Symtech molds to be put into
    public static final Map<OrePrefix, ItemStack> mapMolds = new HashMap<>();

    public static void init() {
        SymtechOrePrefix.catalystBed.addProcessingHandler(PropertyKey.DUST, SymtechMaterialRecipeHandler::processCatalystBed);
        SymtechOrePrefix.catalystPellet.addProcessingHandler(PropertyKey.DUST, SymtechMaterialRecipeHandler::processCatalystPellet);
        SymtechOrePrefix.sheetedFrame.addProcessingHandler(PropertyKey.DUST, SymtechMaterialRecipeHandler::processSheetedFrame);
        SymtechOrePrefix.sheetedFrame.addProcessingHandler(PropertyKey.DUST, RecyclingRecipeHandler::processCrushing);
        SymtechOrePrefix.fiber.addProcessingHandler(SymtechPropertyKey.FIBER, SymtechMaterialRecipeHandler::processFiber);
        SymtechOrePrefix.thread.addProcessingHandler(SymtechPropertyKey.FIBER, SymtechMaterialRecipeHandler::processThread);
        SymtechOrePrefix.thread.addProcessingHandler(SymtechPropertyKey.FIBER, SymtechMaterialRecipeHandler::processThreadWeaving);
        SymtechOrePrefix.fiber.addProcessingHandler(PropertyKey.DUST, RecyclingRecipeHandler::processCrushing);
        SymtechOrePrefix.thread.addProcessingHandler(PropertyKey.DUST, RecyclingRecipeHandler::processCrushing);
        SymtechOrePrefix.electrode.addProcessingHandler(PropertyKey.DUST, SymtechMaterialRecipeHandler::processElectrode);
        addProcessingHandler(PropertyKey.DUST, OrePrefix.dust, SymtechMaterialFlags.HIP_PRESSED, SymtechMaterialRecipeHandler::processHIPPressing);
        addProcessingHandler(PropertyKey.DUST, OrePrefix.dust, SymtechMaterialFlags.CONTINUOUSLY_CAST, SymtechMaterialRecipeHandler::processContinuouslyCast);
    }
    ...
    public static void processHIPPressing(OrePrefix orePrefix, Material material, DustProperty dustProperty) {
        ...
        Item stMetaItem = Item.getByNameOrId("gregtech:meta_item_2");
        if (stMetaItem != null) {
            mapMolds.put(OrePrefix.stickLong, new ItemStack(stMetaItem, 1, 111));
            SymtechRecipeMaps.HOT_ISOSTATIC_PRESS.recipeBuilder()
                    .input(dust, material)
                    .notConsumable(new ItemStack(stMetaItem, 1, 112))
            ...
            SymtechRecipeMaps.HOT_ISOSTATIC_PRESS.recipeBuilder()
                    .input(dust, material)
                    .notConsumable(new ItemStack(stMetaItem, 1, 106))
                    .fluidInputs(Argon.getFluid(100))
    ...
    public static void processElectrode(OrePrefix orePrefix, Material material, DustProperty dustProperty) {
        ...
        SymtechRecipeMaps.GAS_ATOMIZER.recipeBuilder()
    ...
    public static void processCatalystBed(OrePrefix catalystBedPrefix, Material mat, DustProperty property) {
        if (mat.hasFlag(SymtechMaterialFlags.GENERATE_CATALYST_BED)) {
            ModHandler.addShapedRecipe(String.format("catalyst_bed_%s", mat),
                    OreDictUnifier.get(catalystBedPrefix, mat, 1),
                    " S ", "SCS", " S ",
                    'S', new UnificationEntry(SymtechOrePrefix.catalystPellet, mat),
                    'C', SymtechMetaItems.CATALYST_BED_SUPPORT_GRID);

            RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                    .input(SymtechOrePrefix.catalystPellet, mat, 4)
                    .input(SymtechMetaItems.CATALYST_BED_SUPPORT_GRID)
    ...
    public static void processCatalystPellet(OrePrefix catalystPelletPrefix, Material mat, DustProperty property) {
        if (mat.hasFlag(SymtechMaterialFlags.GENERATE_CATALYST_PELLET)) {
    ...
    public static void processFiber(OrePrefix fiberPrefix, Material mat, @NotNull FiberProperty property) {
        if (property.solutionSpun) {
            SymtechRecipeMaps.DRYER_RECIPES.recipeBuilder()
                    .inputs(OreDictUnifier.get(SymtechOrePrefix.wetFiber, mat, 8))
    ...
    public static void processThread(OrePrefix threadPrefix, Material mat, @NotNull FiberProperty property) {
        SymtechRecipeMaps.SPINNING_RECIPES.recipeBuilder()
                .inputs(OreDictUnifier.get(SymtechOrePrefix.fiber, mat, 4))
    ...
    public static void processSheetedFrame(OrePrefix sheetedFramePrefix, Material mat, DustProperty property) {
        ...
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .output(SymtechOrePrefix.sheetedFrame, mat, 6)
                .EUt(7)
        ...
        if (mat.hasProperty(PropertyKey.DUST)) {
            RecipeMaps.MACERATOR_RECIPES.recipeBuilder()
                    .input(SymtechOrePrefix.sheetedFrame, mat, 6)
                    .output(dust, mat, 5)
        ...
        if (mat.hasFluid()) {
            ...
            RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                    .input(SymtechOrePrefix.sheetedFrame, mat, 1)
