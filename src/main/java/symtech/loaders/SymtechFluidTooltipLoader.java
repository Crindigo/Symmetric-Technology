...
public class SymtechFluidTooltipLoader {

    public static void registerTooltips() {
        Supplier<List<String>> liquidVoidableTooltip = () -> Lists.newArrayList(TextFormatting.YELLOW + I18n.format("symtech.fluid.voiding.liquid"));
        Supplier<List<String>> gasVoidableTooltip = () -> Lists.newArrayList(TextFormatting.YELLOW + I18n.format("symtech.fluid.voiding.gas"));
        Supplier<List<String>> flammableVoidableTooltip = () -> Lists.newArrayList(TextFormatting.YELLOW + I18n.format("symtech.fluid.voiding.flammable"));
