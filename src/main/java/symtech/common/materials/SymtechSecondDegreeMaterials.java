...
public class SymtechSecondDegreeMaterials {

    public static void init() {
        Gabbro = new Material.Builder(27200, SymtechUtility.symId("gabbro"))
                .dust()
        ...
        Gneiss = new Material.Builder(27201, SymtechUtility.symId("gneiss"))
                .dust()
        ...
        Limestone = new Material.Builder(27202, SymtechUtility.symId("limestone"))
                .dust()
        ...
        Phyllite = new Material.Builder(27203, SymtechUtility.symId("phyllite"))
                .dust()
        ...
        Shale = new Material.Builder(27204, SymtechUtility.symId("shale"))
                .dust()
        ...
        Slate = new Material.Builder(27205, SymtechUtility.symId("slate"))
                .dust()
        ...
        Kimberlite = new Material.Builder(27206, SymtechUtility.symId("kimberlite"))
                .dust()
        ...
        Anorthosite = new Material.Builder(27207, SymtechUtility.symId("anorthosite"))
                .dust()
