...
import symtech.api.capability.impl.SymtechTurbineRecipeLogic;
import symtech.common.blocks.BlockAlternatorCoil;
...
public class MetaTileEntitySymtechLargeTurbine extends FuelMultiblockController implements ITieredMetaTileEntity {
    ...
    public MetaTileEntitySymtechLargeTurbine(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, int tier, IBlockState casingState, IBlockState rotorState, ICubeRenderer casingRenderer, ICubeRenderer frontOverlay) {
        ...
        this.tier = tier;
        this.recipeMapWorkable = new SymtechTurbineRecipeLogic(this);
        this.recipeMapWorkable.setMaximumOverclockVoltage(GTValues.V[tier]);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySymtechLargeTurbine(metaTileEntityId, recipeMap, tier, casingState, rotorState, casingRenderer, frontOverlay);
    }

    @Override
    protected void addDisplayText(List<ITextComponent> textList) {
        if (isStructureFormed()) {
            FluidStack fuelStack = ((SymtechTurbineRecipeLogic) recipeMapWorkable).getInputFluidStack();
    ...
    protected IBlockState copperCoilState() {
        return SymtechBlocks.ALTERNATOR_COIL.getState(BlockAlternatorCoil.AlternatorCoilType.COPPER);
    }
