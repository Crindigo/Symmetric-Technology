package symtech.common.metatileentities.single.steam;
...
public class SymtechSimpleSteamMetaTileEntity extends SteamMetaTileEntity implements IGhostSlotConfigurable {

    protected SymtechSteamProgressIndicator progressIndicator;
    ...
    public SymtechSimpleSteamMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, SymtechSteamProgressIndicator progressIndicator, ICubeRenderer renderer, boolean isBrickedCasing, boolean isHighPressure) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new SymtechSimpleSteamMetaTileEntity(metaTileEntityId, workableHandler.getRecipeMap(), progressIndicator, renderer, isBrickedCasing, isHighPressure);
    }
    ...
    protected TextureArea getCircuitSlotOverlay() {
        return SymtechGuiTextures.INT_CIRCUIT_OVERLAY_STEAM.get(isHighPressure);
    }
    ...
    protected TextureArea[] getOverlaysForSlot(boolean isOutputs, boolean isFluid) {
        return new TextureArea[] {isFluid ? SymtechGuiTextures.FLUID_SLOT_STEAM.get(isHighPressure) : GuiTextures.SLOT_STEAM.get(isHighPressure)};
    }
