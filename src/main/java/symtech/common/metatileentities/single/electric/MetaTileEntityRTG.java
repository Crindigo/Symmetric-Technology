package symtech.common.metatileentities.single.electric;
...
public class MetaTileEntityRTG extends TieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @NotNull List<String> tooltip, boolean advanced) {
        tooltip.add(I18n.format("symtech.machine.rtg.tooltip.info"));
        tooltip.add(I18n.format("symtech.machine.rtg.tooltip.description"));
        tooltip.add(I18n.format("symtech.machine.rtg.voltage_produced", new Object[]{GTValues.VH[getTier() - 1], GTValues.VNF[this.getTier()-1]}));
