...
public class SymtechStoneVariantBlock extends VariantBlock<SymtechStoneVariantBlock.StoneType> {
    ...
    public SymtechStoneVariantBlock(@Nonnull StoneVariant stoneVariant) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(@NotNull IBlockState state, @NotNull Random rand, int fortune) {
        return Item.getItemFromBlock(this.stoneVariant == StoneVariant.SMOOTH ?
                SymtechBlocks.SYMTECH_STONE_BLOCKS.get(StoneVariant.COBBLE) : this);
    }
    ...
    public enum StoneVariant {
        SMOOTH("symtech_stone_smooth"),
        COBBLE("symtech_stone_cobble", 2.0F, 10.0F),
        BRICKS("symtech_stone_bricks", 0.25);
//      TODO
...
//        BRICKS_SQUARE("stone_bricks_square");
    ...
    public enum StoneType implements IStringSerializable {
        ...
        public gregtech.api.unification.material.Material getMaterial() {
            return switch (this) {
                case GABBRO -> SymtechMaterials.Gabbro;
                case GNEISS -> SymtechMaterials.Gneiss;
                case LIMESTONE -> SymtechMaterials.Limestone;
                case PHYLLITE -> SymtechMaterials.Phyllite;
                case QUARTZITE -> Materials.Quartzite;
                case SHALE -> SymtechMaterials.Shale;
                case SLATE -> SymtechMaterials.Slate;
                case SOAPSTONE -> Materials.Soapstone;
                case KIMBERLITE -> SymtechMaterials.Kimberlite;
                case ANORTHOSITE -> SymtechMaterials.Anorthosite;
