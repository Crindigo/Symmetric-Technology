...
public class SymtechBlocks {
    ...
    public static final EnumMap<SymtechStoneVariantBlock.StoneVariant, SymtechStoneVariantBlock> SYMTECH_STONE_BLOCKS = new EnumMap<>(SymtechStoneVariantBlock.StoneVariant.class);
    ...
    public static BlockSymtechMultiblockCasing MULTIBLOCK_CASING;
    ...
    public static void init() {
        ...
        for (SymtechStoneVariantBlock.StoneVariant shape : SymtechStoneVariantBlock.StoneVariant.values()) {
            SYMTECH_STONE_BLOCKS.put(shape, new SymtechStoneVariantBlock(shape));
        }
        ...
        MULTIBLOCK_CASING = new BlockSymtechMultiblockCasing();
        MULTIBLOCK_CASING.setRegistryName("symtech_multiblock_casing");
    ...
    public static void registerItemModels() {
        ...
        for (SymtechStoneVariantBlock block : SYMTECH_STONE_BLOCKS.values())
