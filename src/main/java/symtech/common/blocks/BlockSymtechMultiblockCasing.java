...
public class BlockSymtechMultiblockCasing extends VariantBlock<BlockSymtechMultiblockCasing.CasingType> {

    public BlockSymtechMultiblockCasing() {
        super(Material.IRON);
        setTranslationKey("symtech_multiblock_casing");
        setHardness(5.0f);
        setResistance(10.0f);
