...
public class SymtechMetaBlocks {
    ...
    public SymtechMetaBlocks() {}

    public static void init() {
        createGeneratedBlock(m -> m.hasProperty(PropertyKey.DUST) && m.hasFlag(GENERATE_FRAME), SymtechMetaBlocks::createSheetedFrameBlock);
    }
    ...
    public static void registerOreDict() {
        for (Entry<Material, BlockSheetedFrame> entry : SHEETED_FRAMES.entrySet()) {
            ...
            OreDictUnifier.registerOre(itemStack, SymtechOrePrefix.sheetedFrame, material);
