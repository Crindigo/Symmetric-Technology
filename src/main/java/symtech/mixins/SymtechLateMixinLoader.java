...
public class SymtechLateMixinLoader implements ILateMixinLoader {
    ...
    public List<String> getMixinConfigs() {
        return modMixins.stream().map(mod -> "mixins.symtech." + mod + ".json").collect(Collectors.toList());
    }
