package symtech.api.capability.impl;

import gregtech.api.capability.impl.MultiblockFuelRecipeLogic;
import gregtech.api.recipes.Recipe;
import net.minecraftforge.fluids.FluidStack;
import symtech.common.metatileentities.multi.electric.MetaTileEntitySymtechLargeTurbine;

public class SymtechTurbineRecipeLogic extends MultiblockFuelRecipeLogic {

    public SymtechTurbineRecipeLogic(MetaTileEntitySymtechLargeTurbine tileEntity) {
        super(tileEntity);
    }
