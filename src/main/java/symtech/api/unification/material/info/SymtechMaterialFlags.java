package symtech.api.unification.material.info;
...
public class SymtechMaterialFlags {
    ...
    public static final MaterialFlag GENERATE_FIBER = (new MaterialFlag.Builder("generate_fiber"))
            .requireProps(new PropertyKey[]{SymtechPropertyKey.FIBER})
            .build();
