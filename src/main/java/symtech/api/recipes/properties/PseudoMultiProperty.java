...
public class PseudoMultiProperty extends RecipeProperty<PseudoMultiPropertyValues> {
    ...
    public void drawInfo(@NotNull Minecraft minecraft, int x, int y, int color, Object value) {
        ...
        String localisedBlockGroupMembers = I18n.format("symtech.block_group_members." + propertyValue.getBlockGroupName() + ".name");
        minecraft.fontRenderer.drawString(I18n.format("symtech.recipe.blocks", localisedBlockGroupMembers), x, y, color);
    }
