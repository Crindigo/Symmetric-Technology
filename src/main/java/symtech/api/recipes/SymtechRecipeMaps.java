...
public class SymtechRecipeMaps {
    ...
    public static final RecipeMap<PseudoMultiRecipeBuilder> LATEX_COLLECTOR_RECIPES = new RecipeMap<>("latex_collector", 0, 2, 1, 2, new PseudoMultiRecipeBuilder(), false)
            .setProgressBar(SymtechGuiTextures.PROGRESS_BAR_EXTRACTION, ProgressWidget.MoveType.VERTICAL_DOWNWARDS)
    ...
    public static final RecipeMap<CatalystRecipeBuilder> FIXED_BED_REACTOR_RECIPES = new RecipeMap<>("fixed_bed_reactor", 2, 1, 3, 2, new CatalystRecipeBuilder(), false)
            .setSlotOverlay(false, false, SymtechGuiTextures.CATALYST_BED_OVERLAY)
    ...
    public static final RecipeMap<CatalystRecipeBuilder> TRICKLE_BED_REACTOR_RECIPES = new RecipeMap<>("trickle_bed_reactor", 2, 0, 3, 2, new CatalystRecipeBuilder(), false)
            .setSlotOverlay(false, false, SymtechGuiTextures.CATALYST_PELLET_OVERLAY)
            .setSlotOverlay(false, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(true, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSound(GTSoundEvents.CHEMICAL_REACTOR);
    ...
    public static final RecipeMap<CatalystRecipeBuilder> BUBBLE_COLUMN_REACTOR_RECIPES = new RecipeMap<>("bubble_column_reactor", 1, 0, 3, 2, new CatalystRecipeBuilder(), false)
            .setSlotOverlay(false, false, SymtechGuiTextures.LARGE_REACTOR_ITEM_OVERLAY)
            .setSlotOverlay(false, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(true, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSound(GTSoundEvents.CHEMICAL_REACTOR);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> ION_EXCHANGE_COLUMN_RECIPES = new RecipeMap<>("ion_exchange_column", 2, 1, 2, 2, new SimpleRecipeBuilder(), false)
            ...
            .setSlotOverlay(false, false, true, SymtechGuiTextures.CUBIC_LATTICE_OVERLAY)
            .setSlotOverlay(false, true, true, GuiTextures.MOLECULAR_OVERLAY_4)
            .setSlotOverlay(true, false, true, SymtechGuiTextures.CUBIC_LATTICE_OVERLAY)
    ...
    public static final RecipeMap<CatalystRecipeBuilder> FLUIDIZED_BED_REACTOR_RECIPES = new RecipeMap<>("fluidized_bed_reactor", 2, 3, 3, 3, new CatalystRecipeBuilder(), false)
            .setSlotOverlay(false, true, SymtechGuiTextures.LARGE_REACTOR_FLUID_OVERLAY)
            .setSlotOverlay(true, true, SymtechGuiTextures.LARGE_REACTOR_FLUID_OVERLAY)
            .setSlotOverlay(false, false, SymtechGuiTextures.LARGE_REACTOR_ITEM_OVERLAY)
            .setSlotOverlay(true, false, SymtechGuiTextures.LARGE_REACTOR_ITEM_OVERLAY)
            .setSound(GTSoundEvents.CHEMICAL_REACTOR);
    ...
    public static final RecipeMap<SimpleRecipeBuilder> ELECTROLYTIC_CELL_RECIPES = new RecipeMap<>("electrolytic_cell", 3, 3, 3, 4, new SimpleRecipeBuilder(), false)
            .setSlotOverlay(false, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(true, true, GuiTextures.MOLECULAR_OVERLAY_3)
            .setSlotOverlay(false, false, SymtechGuiTextures.ELECTRODE_OVERLAY)
            .setSlotOverlay(true, false, GuiTextures.MOLECULAR_OVERLAY_1)
    ...
    public static final RecipeMap<SimpleRecipeBuilder> GRAVITY_SEPARATOR_RECIPES = new RecipeMap<>("gravity_separator", 1, 6, 1, 3, new SimpleRecipeBuilder(), false)
            ...
            .setSlotOverlay(false, true, false, SymtechGuiTextures.SIFTER_FLUID_OVERLAY)
            .setSlotOverlay(false, true, true, SymtechGuiTextures.SIFTER_FLUID_OVERLAY)
            ...
            .setSlotOverlay(true, true, false, SymtechGuiTextures.SIFTER_FLUID_OVERLAY)
            .setSlotOverlay(true, true, true, SymtechGuiTextures.SIFTER_FLUID_OVERLAY)
            .setSound(GTSoundEvents.MACERATOR);
    ...
    static {
        ...
        SymtechRecipeMaps.ADVANCED_ARC_FURNACE.onRecipeBuild(recipeBuilder ->
                recipeBuilder.fluidInputs(SymtechMaterials.RefractoryGunningMixture.getFluid(50))
        );

        SymtechRecipeMaps.METALLURGICAL_CONVERTER.onRecipeBuild(recipeBuilder ->
                recipeBuilder.fluidInputs(SymtechMaterials.RefractoryGunningMixture.getFluid(50))
        );


        MIXER_RECIPES.onRecipeBuild(recipeBuilder -> SymtechRecipeMaps.BLENDER_RECIPES.recipeBuilder()
                .inputs(recipeBuilder.getInputs().toArray(new GTRecipeInput[0]))
                .fluidInputs(recipeBuilder.getFluidInputs())
                .outputs(recipeBuilder.getOutputs())
                .chancedOutputs(recipeBuilder.getChancedOutputs())
