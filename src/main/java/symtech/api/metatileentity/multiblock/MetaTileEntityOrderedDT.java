...
import symtech.common.recipes.DistillationTowerRecipeLogic;
...
public abstract class MetaTileEntityOrderedDT extends RecipeMapMultiblockController implements IDistillationTower {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @NotNull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("symtech.machine.ordered_dt.tooltip.1"));
        tooltip.add(I18n.format("symtech.machine.ordered_dt.tooltip.2"));
    }
}
