...
import symtech.loaders.SymtechFluidTooltipLoader;
...
public class ClientProxy extends CommonProxy {
    ...
    public void preLoad() {
        super.preLoad();
        SymtechMetaEntities.initRenderers();
    }

    @Override
    public void load() {
        super.load();
        SymtechMetaBlocks.registerColors();
        SymtechFluidTooltipLoader.registerTooltips();
    }
    ...
    public static void addPipelinerTooltip(@Nonnull ItemTooltipEvent event) {
        ...
        if (stack.getItem() instanceof IGTTool tool
            ...
            tooltips.add(I18n.format("item.symtech.tool.tooltip.pipeliner",
    ...
    public static void addCatalystTooltipHandler(@Nonnull ItemTooltipEvent event) {
        ...
        for (CatalystGroup group :
            ...
            if (catalystInfo != null) {
                tooltips.add(TextFormatting.UNDERLINE + (TextFormatting.BLUE + I18n.format("symtech.catalyst_group." + group.getName() + ".name")));
                if(catalystInfo.getTier() == CatalystInfo.NO_TIER){
                    ...
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.yield", catalystInfo.getYieldEfficiency()));
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.energy", catalystInfo.getEnergyEfficiency()));
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.speed", catalystInfo.getSpeedEfficiency()));
                } else {
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.tier", GTValues.V[catalystInfo.getTier()], GTValues.VNF[catalystInfo.getTier()]));
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.yield.tiered", catalystInfo.getYieldEfficiency()));
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.energy.tiered", catalystInfo.getEnergyEfficiency()));
                    tooltips.add(I18n.format("symtech.universal.catalysts.tooltip.speed.tiered", catalystInfo.getSpeedEfficiency()));
                }
            }
        }
    ...
    public static void registerModels(@NotNull ModelRegistryEvent event) {
        SymtechBlocks.registerItemModels();
        SymtechMetaBlocks.registerItemModels();
    }
}
