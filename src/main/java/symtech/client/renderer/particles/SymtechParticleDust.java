...
public class SymtechParticleDust extends ParticleSmokeNormal {

    public SymtechParticleDust(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i46348_8_, double p_i46348_10_, double p_i46348_12_, float scale, float maxAge, int color) {
